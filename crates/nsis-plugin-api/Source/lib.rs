...
/// Initis the global variables used by NSIS functions: [`push`], [`pushstr`],
/// [`pushint`], [`pop`], [`popstr`] and [`popint`]
///
/// # Safety
///
...
impl Error {
	...
	pub fn push_err(&self) { let _ = unsafe { pushstr(self.description()) }; }
}
...
/// # Safety
///
/// This function reads static variables and should only be called after
...
pub fn encode_utf16(str:&str) -> Vec<u16> {
	str.encode_utf16().chain(iter::once(0)).collect::<Vec<u16>>()
}
